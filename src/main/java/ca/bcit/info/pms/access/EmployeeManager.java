...
public class EmployeeManager implements Serializable
{
	...
	/**
	 * Check if the user is in the HR table. Need to expand it or refactor for
	 * other "roles"
	 * 
	 * @param userName
	 * @return a string representing the role/level of authorization
	 */
	public String getRole( String userName )
	{
		...
		Query query = entityManager
		        .createNativeQuery( "SELECT employeeID FROM HR WHERE employeeID = '"
		                + emp.getId() + "'" );
		try
		{
			String match = ( String ) query.getSingleResult();
			System.out.println( "found, HR:" );
			return "HR";
		} catch ( NoResultException nre )
		{
			nre.printStackTrace();
