...
public class EmployeeController implements Serializable
{
	...
	/**
	 * Hold info about new employee's timesheet approver username from and to
	 * form.
	 */
	...
	/**
	 * find employee with username = supervisorUsername, and set it as
	...
	private boolean addEmpTimesheetApprover()
	{
		...
		} else
		{
			...
			{
				FacesContext.getCurrentInstance().addMessage(
				        "employeeForm:mnTimesheetApprover",
	...
	/**
	 * Edit an employee's profile. NOTE: from viewEmployee.xhtml to edit,
	 * employee object is lost before page hit action method because
	 * requestScoped.
	 * 
	 * @return navigation view-id
	 */
